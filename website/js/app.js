...
const sectionsObject = document.querySelectorAll('section');

// Converting array like object into an array using the spread operator 
...
window.addEventListener('resize', function () {
    header_height = document.querySelector('.page__header').offsetHeight;
...
function fadeHeader(scroll_pos) {
    ...
    // Fade header when not scrolling
...
window.addEventListener('scroll', function (e) {
    ...
    fadeHeader(last_known_scroll_position);
